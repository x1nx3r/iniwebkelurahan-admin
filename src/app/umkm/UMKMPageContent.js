// iniwebumkm-admin/src/app/umkm/UMKMPageContent.js
"use client";
...
export default function UMKMPageContent() {
  ...
  useEffect(() => {
    filterUMKM();
  }, [umkm, searchTerm, selectedStatus]);
  ...
  const handleView = (umkmItem) => {
    setSelectedUMKM(umkmItem);
    setViewModalOpen(true);
  };

  const handleEdit = (umkmItem) => {
    setSelectedUMKM(umkmItem);
    ...
    <AdminLayout>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        <div className="space-y-8 p-6">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-600 mt-2">
                      Kelola semua UMKM di Kelurahan Kemayoran
                    </p>
          ...
          {/* UMKM List with enhanced container */}
          <div className="relative">
